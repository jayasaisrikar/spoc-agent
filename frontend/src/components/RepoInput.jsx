        ...
        >
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-lg font-semibold text-gray-900">Analyze GitHub Repository</h2>
            </div>
            <button
              onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full bg-white border rounded-lg px-4 py-3 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-900 ${
            ...
            <div className="space-y-2">
              <p className="text-sm font-medium text-gray-600">Example repositories:</p>
              <div className="space-y-1">
                {exampleRepos.map((repo, index) => (
                  <button
                    ...
                    type="button"
                    onClick={() => setUrl(repo)}
                    className="block w-full text-left text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded px-2 py-1 transition-colors"
                  >
            ...
            <button
              ...
              className="w-full bg-gray-900 hover:bg-gray-800 disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
          ...
          <div className="mt-4 p-3 bg-gray-50 rounded-lg">
            <h4 className="text-sm font-medium text-gray-700 mb-2">What we analyze:</h4>
